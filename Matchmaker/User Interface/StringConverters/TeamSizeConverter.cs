...
{
    class TeamSizeConverter : EnumStringConverter<TeamSize>
    {
        public override TeamSize StringToEnum(string value) => EnumStringConverter.ParseTeamSize(value);
        public override string EnumToString(TeamSize value) => EnumStringConverter.ToUserFriendlyString(value);
    }
